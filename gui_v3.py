...
upload_file_icon = ImageTk.PhotoImage(
    Image.open(relative_to_assets("upload_file.png")).resize((30, 30), Image.ANTIALIAS)
)
...
def process():
    ...
    upload_button_frame_1.place(relx=0.1, rely=0.1, relheight=0.15, relwidth=0.8)
    ...
    upload_button_frame_2.place(relx=0.1, rely=0.3, relheight=0.15, relwidth=0.8)
